...
username_button = tk.Button(top_frame, text="Connect", font=BUTTON_FONT, bg='black', fg='white', command=connect)
...
def listen_for_messages_from_server(client):
    ...
    while 1:
        ...
        if message != '':
            ...
            add_message(f"From {username}:{content}")
            
        else:
            messagebox.showerror("Error", "Message recevied from client can't be empty")
